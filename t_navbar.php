            ...
            <div class="container">
                ...
                <div id="main-nav" class="collapse navbar-collapse">
                    <ul class="navbar-nav ml-auto">
                        <li><span class="badge badge-info mt-5">Anik Sen<br>Math</span></li>
                        <li class="dropdown">
                                <a class="nav-item nav-link" data-toggle="dropdown">Profile</a>
                                <div class="dropdown-menu">
                                    <a href="t_profile.php" class="dropdown-item">Profile</a>
                                    <a href="t_edit_profile.php" class="dropdown-item">Edit Profile</a>
                                </div>
                            </li>
                            <li><a class="nav-item nav-link" type="button" data-bs-toggle="modal" data-bs-target="#myModal">Marks</a></li>
                                <!-- The Modal -->
                                    <div class="modal" id="myModal">
                                        <div class="modal-dialog modal-dialog-centered">
                                            ...
                                            <div class="modal-header">
                                                <h4 class="modal-title"><b>Marks</b></h4>
                                            ...
                                            <form action="" method="post">
                                                ...
                                                <div class="modal-footer">
                                                    <a type="submit" href="t_marks.php" class="btn btn-primary" >Submit</a>
                                                </div>
                            ...
                            <li><a href="t_salary.php" type="button" class="nav-item nav-link">Salary</a></li>
                            <li class="dropdown">
                                <a href="#" class="nav-item nav-link" data-toggle="dropdown">Chat</a>
                                <div class="dropdown-menu">
                                    <a href="#" class="dropdown-item">All messages</a>
                                    <a href="#" class="dropdown-item">Chat with Admin</a>
                                    <a href="#" class="dropdown-item">Chat with Students</a>
                                </div>
                            </li>
